...
[![Tests](https://img.shields.io/badge/Tests-251%20Passing-brightgreen?logo=pytest&logoColor=white)](#proven-not-theoretical)
...
**251 tests passing** across 11 test files:
...
| `test_constraints.py` | 47 | Era blocklists, genre inference, anachronism detection, fact contradiction (age/role/relationship/timeline), word extraction, extraction validation, coverage checks |
...
```bash
pytest tests/ -v --tb=short  # 251 passed in ~7.2s
```
